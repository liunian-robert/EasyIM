package com.easyim.framework.aspectj;
...
import com.easyim.common.enums.BusinessStatus;
import com.easyim.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.easyim.common.annotation.Log)")
